-- Function: exams.fn_deactive_parent_questions_exams(bigint, bigint, smallint, smallint, jsonb, bigint)

--

CREATE FUNCTION exams.fn_deactive_parent_questions_exams(p_material_id bigint, p_type_material_id bigint, p_course_id smallint, p_week smallint, p_area_ids jsonb, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
ALTER FUNCTION exams.fn_deactive_parent_questions_exams(p_material_id bigint, p_type_material_id bigint, p_course_id smallint, p_week smallint, p_area_ids jsonb, p_updated_by bigint) OWNER TO postgres;
