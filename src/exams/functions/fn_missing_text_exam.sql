-- Function: exams.fn_missing_text_exam(integer, integer, integer)

--

CREATE FUNCTION exams.fn_missing_text_exam(p_material_id integer, p_type_material_id integer, p_week integer) RETURNS TABLE(course_id smallint, material_exam_id bigint, type_report text, description text)
    LANGUAGE plpgsql
    AS $$
                BEGIN
                    RETURN QUERY
                    ...
                    all_areas AS (
                        ...
                        FROM academic.detail_week_type_mat AS dwtm
...
ALTER FUNCTION exams.fn_missing_text_exam(p_material_id integer, p_type_material_id integer, p_week integer) OWNER TO postgres;
