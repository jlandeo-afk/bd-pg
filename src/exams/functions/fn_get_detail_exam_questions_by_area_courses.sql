...
ALTER FUNCTION exams.fn_get_detail_exam_questions_by_area_courses(p_perpage integer, p_npage integer, p_search character varying, p_source character varying, p_course_id smallint, p_type_material_id smallint, p_material_id bigint, p_week smallint, p_area character varying) OWNER TO postgres;
