-- Function: exams.fn_get_exam_inconsistency_status(bigint, bigint, bigint)

--

CREATE FUNCTION exams.fn_get_exam_inconsistency_status(p_cycle_id bigint, p_university_id bigint, p_company_id bigint) RETURNS text
    LANGUAGE plpgsql
    AS $$
                    DECLARE
...
ALTER FUNCTION exams.fn_get_exam_inconsistency_status(p_cycle_id bigint, p_university_id bigint, p_company_id bigint) OWNER TO postgres;
