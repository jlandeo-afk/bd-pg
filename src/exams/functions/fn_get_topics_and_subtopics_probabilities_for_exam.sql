-- Function: exams.fn_get_topics_and_subtopics_probabilities_for_exam(bigint, smallint, smallint, bigint)

--

CREATE FUNCTION exams.fn_get_topics_and_subtopics_probabilities_for_exam(p_material_id bigint, p_course_id smallint, p_week smallint, p_type_material_id bigint) RETURNS TABLE(topic_id smallint, topic_probability numeric, subtopics_probabilities jsonb)
    LANGUAGE plpgsql
    AS $$
        BEGIN
            RETURN QUERY
...
ALTER FUNCTION exams.fn_get_topics_and_subtopics_probabilities_for_exam(p_material_id bigint, p_course_id smallint, p_week smallint, p_type_material_id bigint) OWNER TO postgres;
