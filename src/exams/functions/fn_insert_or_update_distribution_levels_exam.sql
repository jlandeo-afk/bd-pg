-- Function: exams.fn_insert_or_update_distribution_levels_exam(bigint, bigint, jsonb, bigint, bigint)

--

CREATE FUNCTION exams.fn_insert_or_update_distribution_levels_exam(p_cycle_id bigint, p_type_material_id bigint, p_exam_materials jsonb, p_user bigint, p_company_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION exams.fn_insert_or_update_distribution_levels_exam(p_cycle_id bigint, p_type_material_id bigint, p_exam_materials jsonb, p_user bigint, p_company_id bigint) OWNER TO postgres;
