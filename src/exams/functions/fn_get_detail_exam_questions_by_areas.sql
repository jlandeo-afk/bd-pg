-- Function: exams.fn_get_detail_exam_questions_by_areas(integer, integer, character varying, character varying, smallint, smallint, bigint, smallint)

--

CREATE FUNCTION exams.fn_get_detail_exam_questions_by_areas(p_perpage integer, p_npage integer, p_search character varying, p_source character varying, p_area_id smallint, p_type_material_id smallint, p_material_id bigint, p_week smallint) RETURNS TABLE(area character varying, area_id bigint, id bigint, description text, status character varying, course character varying, code character varying, source text, is_duplicated boolean, type_question text, exam_area character varying, exam_areas jsonb, total bigint)
    LANGUAGE plpgsql
    AS $$
                        DECLARE
                            offset_val INTEGER;
...
ALTER FUNCTION exams.fn_get_detail_exam_questions_by_areas(p_perpage integer, p_npage integer, p_search character varying, p_source character varying, p_area_id smallint, p_type_material_id smallint, p_material_id bigint, p_week smallint) OWNER TO postgres;
