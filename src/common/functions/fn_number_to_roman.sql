-- Function: common.fn_number_to_roman(smallint)

--

CREATE FUNCTION common.fn_number_to_roman(num smallint) RETURNS character varying
...
ALTER FUNCTION common.fn_number_to_roman(num smallint) OWNER TO postgres;
