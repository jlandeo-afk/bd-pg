-- Function: common.fn_params_index(bigint, smallint)

--

CREATE FUNCTION common.fn_params_index(p_question_id bigint, p_subtopic_id smallint DEFAULT NULL::smallint) RETURNS TABLE(id bigint, course_id smallint, code_course character varying, course character varying, topic_id smallint, code_topic character varying, topic character varying, subtopics jsonb, level_id smallint, level character varying, type character varying, ter numeric, type_question text, status character varying, type_text_template_id smallint, type_text_template_name character varying, description_text character varying, description_subquestion character varying, text_attributes character varying, subquestion_attributes character varying, question_attributes jsonb, shared_status text)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION common.fn_params_index(p_question_id bigint, p_subtopic_id smallint) OWNER TO postgres;
