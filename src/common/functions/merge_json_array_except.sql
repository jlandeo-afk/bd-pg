-- Function: common.merge_json_array_except(json, json)

--

CREATE FUNCTION common.merge_json_array_except(existing json, incoming json) RETURNS json
...
ALTER FUNCTION common.merge_json_array_except(existing json, incoming json) OWNER TO postgres;
