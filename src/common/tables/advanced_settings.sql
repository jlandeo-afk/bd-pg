...
ALTER TABLE ONLY common.advanced_settings
...
ALTER TABLE ONLY common.advanced_settings
    ADD CONSTRAINT odiseo_advanced_settings_company_id_foreign FOREIGN KEY (company_id) REFERENCES organization.companies(id);
