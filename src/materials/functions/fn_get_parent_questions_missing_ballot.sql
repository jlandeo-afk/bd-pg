-- Function: materials.fn_get_parent_questions_missing_ballot(bigint, smallint, smallint, smallint, boolean, integer)

--

CREATE FUNCTION materials.fn_get_parent_questions_missing_ballot(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint, p_has_permission_filter_per_course boolean, p_employee_id integer) RETURNS TABLE(subquestion jsonb, parent_id bigint, category_id bigint, category character varying, subcategory_id bigint, subcategory character varying, level_id bigint, course_id smallint, history jsonb, code character varying, registered boolean)
    LANGUAGE plpgsql
    AS $$
                DECLARE
                    v_ids_children INT[];
...
ALTER FUNCTION materials.fn_get_parent_questions_missing_ballot(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint, p_has_permission_filter_per_course boolean, p_employee_id integer) OWNER TO postgres;
