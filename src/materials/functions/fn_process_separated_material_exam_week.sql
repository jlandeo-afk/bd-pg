...
ALTER FUNCTION materials.fn_process_separated_material_exam_week(p_material_id bigint, p_type_material_id smallint, p_material_exam_area_week_id bigint, p_exam_area_id smallint, p_week smallint, p_fl_solution boolean, p_fl_quality boolean, p_created_by bigint) OWNER TO postgres;
