    ...
    AS $$
            ...
            BEGIN
                ...
                IF p_subquestion IS NOT NULL AND jsonb_typeof(p_subquestion) = 'array' THEN
                    INSERT INTO materials.material_ballot_subquestions (
