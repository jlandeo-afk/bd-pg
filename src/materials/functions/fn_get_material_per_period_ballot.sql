...
ALTER FUNCTION materials.fn_get_material_per_period_ballot(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint, p_employee_id bigint, p_has_permission_generar_por_curso_asignado boolean) OWNER TO postgres;
