-- Function: materials.fn_create_material(bigint, smallint, smallint, bigint, bigint)

--

CREATE FUNCTION materials.fn_create_material(p_cycle_id bigint, p_university_id smallint, p_headquearters_id smallint, p_created_by bigint, p_company_id bigint) RETURNS TABLE(material_id bigint, v_validated integer)
    LANGUAGE plpgsql
    AS $$
        DECLARE
            v_validate BIGINT;
...
ALTER FUNCTION materials.fn_create_material(p_cycle_id bigint, p_university_id smallint, p_headquearters_id smallint, p_created_by bigint, p_company_id bigint) OWNER TO postgres;
