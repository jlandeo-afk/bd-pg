...
ALTER FUNCTION materials.fn_get_ballot_questions(p_perpage integer, p_npage integer, p_search character varying, p_type_material_id integer, p_material_id integer, p_week integer, p_course_id integer, p_topic_id integer, p_subtopic_id integer, p_show_missing_questions boolean, p_university_id smallint, p_option_id smallint, p_modality_id smallint, p_version smallint, p_year character varying) OWNER TO postgres;
