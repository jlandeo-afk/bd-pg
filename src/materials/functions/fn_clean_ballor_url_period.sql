-- Function: materials.fn_clean_ballor_url_period(bigint, character varying, bigint)

--

CREATE FUNCTION materials.fn_clean_ballor_url_period(p_material_per_period_ballot_id bigint, p_type character varying, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
ALTER FUNCTION materials.fn_clean_ballor_url_period(p_material_per_period_ballot_id bigint, p_type character varying, p_updated_by bigint) OWNER TO postgres;
