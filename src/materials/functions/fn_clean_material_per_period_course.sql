-- Function: materials.fn_clean_material_per_period_course(bigint, jsonb, bigint, character varying)

--

CREATE FUNCTION materials.fn_clean_material_per_period_course(p_material_per_period_ballot_id bigint, p_courses jsonb, p_updated_by bigint, p_type character varying DEFAULT NULL::character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
ALTER FUNCTION materials.fn_clean_material_per_period_course(p_material_per_period_ballot_id bigint, p_courses jsonb, p_updated_by bigint, p_type character varying) OWNER TO postgres;
