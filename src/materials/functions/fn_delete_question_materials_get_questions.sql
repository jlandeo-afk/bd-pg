...
ALTER FUNCTION questions.fn_delete_question_materials_get_questions(p_material_id bigint, p_week smallint, p_type_material_ids jsonb, p_deleted_by bigint, p_fl_validate_code boolean) OWNER TO postgres;
