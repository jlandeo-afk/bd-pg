-- Function: materials.fn_get_periods_weeks_on_type_material(bigint, smallint)

--

CREATE FUNCTION materials.fn_get_periods_weeks_on_type_material(p_type_material_id bigint, p_week smallint) RETURNS TABLE(starting_week smallint, ending_week smallint, period_number smallint)
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION materials.fn_get_periods_weeks_on_type_material(p_type_material_id bigint, p_week smallint) OWNER TO postgres;
