...
ALTER FUNCTION materials.fn_save_question_material_exam(p_id bigint, p_material_id bigint, p_type_material_id smallint, p_week smallint, p_area_id smallint, p_question_id bigint, p_subtopic_id smallint, p_level_id smallint, p_created_by bigint) OWNER TO postgres;
