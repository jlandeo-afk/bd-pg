-- Function: materials.fn_get_course_exam_areas_by_config_exam_material_id(bigint, bigint)

--

CREATE FUNCTION materials.fn_get_course_exam_areas_by_config_exam_material_id(p_exam_material_config_id bigint, p_company_id bigint) RETURNS TABLE(course_id smallint, course_name character varying, apply_text boolean, exam_area jsonb, position_course smallint)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION materials.fn_get_course_exam_areas_by_config_exam_material_id(p_exam_material_config_id bigint, p_company_id bigint) OWNER TO postgres;
