...
ALTER FUNCTION materials.fn_list_pagination_type_material_templates(p_per_page integer, p_n_page integer, p_name text, p_fl_exam boolean) OWNER TO postgres;
