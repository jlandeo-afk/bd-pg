-- Function: materials.fn_update_type_material_template(bigint, character varying, jsonb, boolean, bigint, bigint, jsonb)

--

CREATE FUNCTION materials.fn_update_type_material_template(p_id bigint, p_name character varying, p_children_template_ids jsonb, p_fl_exam boolean, p_user_id bigint, p_type_exam_id bigint, p_settings jsonb) RETURNS json
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_old_is_exam bool;
...
ALTER FUNCTION materials.fn_update_type_material_template(p_id bigint, p_name character varying, p_children_template_ids jsonb, p_fl_exam boolean, p_user_id bigint, p_type_exam_id bigint, p_settings jsonb) OWNER TO postgres;
