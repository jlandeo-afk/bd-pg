-- Function: materials.fn_update_type_material_course_single(bigint, boolean, character, bigint, integer, integer, jsonb, jsonb, bigint)

--

CREATE FUNCTION materials.fn_update_type_material_course_single(p_course_id bigint, p_is_generic boolean, p_type_question character, p_material_id bigint, p_amount integer, p_amount_text integer, p_subquestions jsonb, p_weeks_detail jsonb, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
            DECLARE
                v_tmc_id           BIGINT; 
...
ALTER FUNCTION materials.fn_update_type_material_course_single(p_course_id bigint, p_is_generic boolean, p_type_question character, p_material_id bigint, p_amount integer, p_amount_text integer, p_subquestions jsonb, p_weeks_detail jsonb, p_updated_by bigint) OWNER TO postgres;
