-- Function: materials.fn_paginate_type_materials(integer, integer, character varying, bigint, bigint, bigint)

--

CREATE FUNCTION materials.fn_paginate_type_materials(p_perpage integer, p_npage integer, p_search character varying, p_company_id bigint, p_type_material_template_id bigint DEFAULT NULL::bigint, p_cycle_id bigint DEFAULT NULL::bigint) RETURNS TABLE(id bigint, code character varying, description character varying, amount_question integer, fl_status boolean, areas jsonb, cycle_id bigint, name_cycle character varying, fl_exam boolean, fl_class_material boolean, childrens jsonb, thread smallint, percentage numeric, type_material_template_id bigint, total bigint)
...
ALTER FUNCTION materials.fn_paginate_type_materials(p_perpage integer, p_npage integer, p_search character varying, p_company_id bigint, p_type_material_template_id bigint, p_cycle_id bigint) OWNER TO postgres;
