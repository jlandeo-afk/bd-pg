-- Function: materials.fn_get_config_syllabus_register_ballot_period(bigint, smallint, smallint, smallint)

--

CREATE FUNCTION materials.fn_get_config_syllabus_register_ballot_period(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint) RETURNS TABLE(id bigint, type_material_id smallint, amount_type_mat smallint, subtopic_id smallint, code_subtopic character varying, subtopic character varying, week smallint, topic_id smallint, code_topic character varying, topic character varying, course_id bigint, code_course character varying, course character varying, syllabus_id bigint)
    LANGUAGE plpgsql
    AS $$
                DECLARE
                    v_ids_children INT[];
...
ALTER FUNCTION materials.fn_get_config_syllabus_register_ballot_period(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint) OWNER TO postgres;
