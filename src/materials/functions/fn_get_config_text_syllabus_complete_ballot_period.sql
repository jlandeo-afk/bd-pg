    ...
    AS $$
                BEGIN
                    ...
                    WITH type_material_ids AS (
                        ...
                        JOIN materials.type_material_detail_course_texts tmdc ON tmc.id = tmdc.type_material_course_id
...
ALTER FUNCTION materials.fn_get_config_text_syllabus_complete_ballot_period(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint) OWNER TO postgres;
