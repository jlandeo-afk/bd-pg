-- Function: materials.fn_process_material_ballot_by_courses(bigint, jsonb)

--

CREATE FUNCTION materials.fn_process_material_ballot_by_courses(p_material_per_period_ballot_id bigint, p_courses jsonb) RETURNS TABLE(course_id smallint, detail_ids jsonb, week smallint, questions jsonb)
    LANGUAGE plpgsql
    AS $$
    BEGIN
        RETURN QUERY
...
ALTER FUNCTION materials.fn_process_material_ballot_by_courses(p_material_per_period_ballot_id bigint, p_courses jsonb) OWNER TO postgres;
