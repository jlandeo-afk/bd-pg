...
ALTER FUNCTION materials.fn_material_detail_generation(p_material_id integer, p_type_material_id integer, p_week smallint, p_cycle integer) OWNER TO postgres;
