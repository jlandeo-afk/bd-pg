...
ALTER FUNCTION materials.fn_get_questions_register_ballot(p_material_id bigint, p_fl_validate_code boolean, p_type_material_id smallint, p_start_week smallint, p_end_week smallint) OWNER TO postgres;
