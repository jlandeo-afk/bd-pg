-- Function: materials.fn_deactive_ballot_per_period_url(bigint, bigint, smallint, smallint)

--

CREATE FUNCTION materials.fn_deactive_ballot_per_period_url(p_material_id bigint, p_type_material_id bigint, p_start_week smallint, p_end_week smallint) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    WITH material_per_period_ballot_id AS (
        ...
        FROM materials.material_per_period mpp
        JOIN materials.material_per_period_ballot mppb ON mpp.id = mppb.material_per_period_id
        WHERE 1 = 1
...
ALTER FUNCTION materials.fn_deactive_ballot_per_period_url(p_material_id bigint, p_type_material_id bigint, p_start_week smallint, p_end_week smallint) OWNER TO postgres;
