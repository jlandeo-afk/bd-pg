...
ALTER FUNCTION materials.fn_get_questions_missing_ballot(p_material_id bigint, p_fl_validate_code boolean, p_type_material_id smallint, p_start_week smallint, p_end_week smallint, p_has_permission_filter_per_course boolean, p_employee_id integer) OWNER TO postgres;
