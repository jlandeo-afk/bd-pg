-- Function: materials.fn_order_list_material_per_period(bigint, smallint, smallint, smallint, jsonb, bigint)

--

CREATE FUNCTION materials.fn_order_list_material_per_period(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint, p_distribution_orders jsonb, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
            BEGIN
...
ALTER FUNCTION materials.fn_order_list_material_per_period(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint, p_distribution_orders jsonb, p_updated_by bigint) OWNER TO postgres;
