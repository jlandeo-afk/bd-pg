-- Function: materials.fn_update_material_revision_status(bigint, character varying, bigint)

--

CREATE FUNCTION materials.fn_update_material_revision_status(p_revision_id bigint, p_new_status character varying, p_user_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION materials.fn_update_material_revision_status(p_revision_id bigint, p_new_status character varying, p_user_id bigint) OWNER TO postgres;
