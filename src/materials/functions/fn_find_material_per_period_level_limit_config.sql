...
BEGIN
    ...
    WHERE mpllc.id = p_id
      AND mpllc.deleted_at IS NULL;
END;
$$;


ALTER FUNCTION materials.fn_find_material_per_period_level_limit_config(p_id bigint) OWNER TO postgres;
