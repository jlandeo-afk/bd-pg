-- Function: materials.fn_upsert_material_missing_question(integer, bigint, jsonb)

--

CREATE FUNCTION materials.fn_upsert_material_missing_question(p_week_type_material_id integer, p_user_id bigint, p_course_ids jsonb DEFAULT NULL::jsonb) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION materials.fn_upsert_material_missing_question(p_week_type_material_id integer, p_user_id bigint, p_course_ids jsonb) OWNER TO postgres;
