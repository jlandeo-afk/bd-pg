-- Function: materials.fn_create_material_revision(bigint, smallint, smallint, smallint, bigint)

--

CREATE FUNCTION materials.fn_create_material_revision(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint, p_created_by bigint) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION materials.fn_create_material_revision(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint, p_created_by bigint) OWNER TO postgres;
