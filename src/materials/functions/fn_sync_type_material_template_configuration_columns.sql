-- Function: materials.fn_sync_type_material_template_configuration_columns(bigint, bigint, jsonb)

--

CREATE FUNCTION materials.fn_sync_type_material_template_configuration_columns(p_type_material_template_id bigint, p_user_id bigint, p_settings jsonb) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_now  timestamp := NOW();
...
ALTER FUNCTION materials.fn_sync_type_material_template_configuration_columns(p_type_material_template_id bigint, p_user_id bigint, p_settings jsonb) OWNER TO postgres;
