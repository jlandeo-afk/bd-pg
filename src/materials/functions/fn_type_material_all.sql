...
ALTER FUNCTION materials.fn_type_material_all(p_cycle_id bigint, p_fl_exam boolean, p_course_id bigint, p_week bigint, p_all_weeks boolean) OWNER TO postgres;
