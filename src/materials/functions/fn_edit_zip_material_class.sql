-- Function: materials.fn_edit_zip_material_class(jsonb, smallint, character varying, bigint)

--

CREATE FUNCTION materials.fn_edit_zip_material_class(p_detail_week_type_mat_ids jsonb, p_fl_process_class_mat smallint, p_url_zip_class_mat character varying, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION materials.fn_edit_zip_material_class(p_detail_week_type_mat_ids jsonb, p_fl_process_class_mat smallint, p_url_zip_class_mat character varying, p_updated_by bigint) OWNER TO postgres;
