-- Function: materials.get_material_configuration_details(integer, integer, integer, integer, integer)

--

CREATE FUNCTION materials.get_material_configuration_details(p_id integer, p_company_id integer, p_type_material_template_id integer, p_type_template_id integer, p_area_id integer) RETURNS TABLE(id bigint, name character varying, value text)
    LANGUAGE plpgsql
    AS $$
        BEGIN
            RETURN QUERY
...
ALTER FUNCTION materials.get_material_configuration_details(p_id integer, p_company_id integer, p_type_material_template_id integer, p_type_template_id integer, p_area_id integer) OWNER TO postgres;
