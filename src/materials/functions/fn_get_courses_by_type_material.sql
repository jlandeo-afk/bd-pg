-- Function: materials.fn_get_courses_by_type_material(smallint)

--

CREATE FUNCTION materials.fn_get_courses_by_type_material(p_type_material_id smallint) RETURNS TABLE(course_id bigint, course_name character varying)
    LANGUAGE plpgsql
    AS $$
            BEGIN
...
ALTER FUNCTION materials.fn_get_courses_by_type_material(p_type_material_id smallint) OWNER TO postgres;
