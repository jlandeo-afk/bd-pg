...
ALTER FUNCTION materials.fn_update_material_per_period_level_limit_config(p_material_per_period_id bigint, p_start_week smallint, p_end_week smallint, p_lower_level_limit smallint, p_upper_level_limit smallint, p_updated_by bigint) OWNER TO postgres;
