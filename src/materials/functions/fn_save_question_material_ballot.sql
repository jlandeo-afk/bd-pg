...
WHERE
    ...
    IF p_material_distribution_id IS NOT NULL THEN
        UPDATE
            materials.material_ballot_question mdbq
        SET
...
ALTER FUNCTION materials.fn_save_question_material_ballot(p_week smallint, p_question_id bigint, p_subtopic_id smallint, p_level_id smallint, p_position smallint, p_week_type_material_id bigint, p_type_material_id smallint, p_material_id bigint, p_material_distribution_id bigint, p_created_by bigint) OWNER TO postgres;
