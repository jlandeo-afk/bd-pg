...
ALTER FUNCTION materials.fn_remove_question_all_areas_from_material_exam(p_question_id bigint, p_material_id bigint, p_type_material_id smallint, p_week smallint, p_updated_by bigint) OWNER TO postgres;
