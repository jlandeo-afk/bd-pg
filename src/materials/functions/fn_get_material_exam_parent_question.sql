-- Function: materials.fn_get_material_exam_parent_question(bigint)

--

CREATE FUNCTION materials.fn_get_material_exam_parent_question(p_material_exam_parent_question_id bigint) RETURNS TABLE(subquestions_amount smallint)
    LANGUAGE plpgsql
    AS $$
BEGIN
    /*
...
ALTER FUNCTION materials.fn_get_material_exam_parent_question(p_material_exam_parent_question_id bigint) OWNER TO postgres;
