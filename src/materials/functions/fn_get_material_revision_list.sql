-- Function: materials.fn_get_material_revision_list(integer, integer, bigint, bigint, bigint)

--

CREATE FUNCTION materials.fn_get_material_revision_list(p_perpage integer, p_npage integer, p_user_id bigint, p_cycle_id bigint DEFAULT NULL::bigint, p_company_id bigint DEFAULT NULL::bigint) RETURNS TABLE(id bigint, cycle_id bigint, cycle character varying, type_material_id smallint, type_material_description character varying, weeks json, delivery_date timestamp without time zone, verify_date timestamp without time zone, status character varying, course_total bigint, course_amount_verified bigint, total bigint)
    LANGUAGE plpgsql
    AS $$
DECLARE
    offset_val INTEGER;
...
ALTER FUNCTION materials.fn_get_material_revision_list(p_perpage integer, p_npage integer, p_user_id bigint, p_cycle_id bigint, p_company_id bigint) OWNER TO postgres;
