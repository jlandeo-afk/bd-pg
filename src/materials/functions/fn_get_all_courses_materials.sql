-- Function: materials.fn_get_all_courses_materials(integer, integer, text)

--

CREATE FUNCTION materials.fn_get_all_courses_materials(p_type_material_id integer, p_material_per_period_ballot_id integer, p_type_url text) RETURNS TABLE(id bigint, course_id smallint, code character varying, material_per_period_ballot_id bigint, type character varying, job_status character varying, url character varying, course_name character varying, position_order smallint)
    LANGUAGE plpgsql
    AS $$
            DECLARE
...
ALTER FUNCTION materials.fn_get_all_courses_materials(p_type_material_id integer, p_material_per_period_ballot_id integer, p_type_url text) OWNER TO postgres;
