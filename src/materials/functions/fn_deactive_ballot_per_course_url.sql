-- Function: materials.fn_deactive_ballot_per_course_url(bigint, bigint)

--

CREATE FUNCTION materials.fn_deactive_ballot_per_course_url(p_material_revision_course_id bigint, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION materials.fn_deactive_ballot_per_course_url(p_material_revision_course_id bigint, p_updated_by bigint) OWNER TO postgres;
