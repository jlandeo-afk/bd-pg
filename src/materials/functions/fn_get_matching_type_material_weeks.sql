-- Function: materials.fn_get_matching_type_material_weeks(integer, integer, integer)

--

CREATE FUNCTION materials.fn_get_matching_type_material_weeks(p_course_id integer, p_week integer, p_cycle_id integer) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
                    DECLARE
...
ALTER FUNCTION materials.fn_get_matching_type_material_weeks(p_course_id integer, p_week integer, p_cycle_id integer) OWNER TO postgres;
