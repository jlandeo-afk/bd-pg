-- Function: materials.fn_validate_parent_type_mat(smallint, jsonb)

--

CREATE FUNCTION materials.fn_validate_parent_type_mat(p_parent_type_mat_id smallint, p_type_materials jsonb) RETURNS TABLE(not_type_materials smallint[])
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION materials.fn_validate_parent_type_mat(p_parent_type_mat_id smallint, p_type_materials jsonb) OWNER TO postgres;
