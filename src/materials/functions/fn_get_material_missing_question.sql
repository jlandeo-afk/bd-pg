...
ALTER FUNCTION materials.fn_get_material_missing_question(p_perpage integer, p_npage integer, p_course_ids bigint[], p_status text[]) OWNER TO postgres;
