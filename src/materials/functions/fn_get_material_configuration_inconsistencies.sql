...
ALTER FUNCTION materials.fn_get_material_configuration_inconsistencies(p_headquarter_id bigint, p_cycle_id bigint, p_university_id bigint, p_company_id bigint, p_week smallint, p_type_material_id smallint, p_courses jsonb) OWNER TO postgres;
