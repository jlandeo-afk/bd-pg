...
ALTER TABLE ONLY materials.material_ballot_stats_areas
...
ALTER TABLE ONLY materials.material_ballot_stats_areas
    ADD CONSTRAINT fk_stats_areas_global FOREIGN KEY (global_stats_id) REFERENCES materials.material_ballot_stats_global(id) ON DELETE CASCADE;
