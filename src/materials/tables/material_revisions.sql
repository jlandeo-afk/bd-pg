...
ALTER TABLE ONLY materials.material_revisions
...
ALTER TABLE ONLY materials.material_revisions
    ADD CONSTRAINT fk_mat_rev_created_by FOREIGN KEY (created_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY materials.material_revisions
    ADD CONSTRAINT fk_mat_rev_deleted_by FOREIGN KEY (deleted_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY materials.material_revisions
    ADD CONSTRAINT fk_mat_rev_material FOREIGN KEY (material_id) REFERENCES materials.material(id);
...
ALTER TABLE ONLY materials.material_revisions
    ADD CONSTRAINT fk_mat_rev_type_material FOREIGN KEY (type_material_id) REFERENCES materials.type_material(id);
...
ALTER TABLE ONLY materials.material_revisions
    ADD CONSTRAINT fk_mat_rev_updated_by FOREIGN KEY (updated_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY materials.material_revisions
    ADD CONSTRAINT fk_mat_rev_verified_by FOREIGN KEY (verified_by) REFERENCES auth.users(id);
