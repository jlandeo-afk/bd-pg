...
ALTER TABLE ONLY materials.material_per_period_course
...
ALTER TABLE ONLY materials.material_per_period_course
    ADD CONSTRAINT material_per_period_course_course_id_foreign FOREIGN KEY (course_id) REFERENCES academic.course(id);
...
ALTER TABLE ONLY materials.material_per_period_course
    ADD CONSTRAINT material_per_period_course_created_by_foreign FOREIGN KEY (created_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY materials.material_per_period_course
    ADD CONSTRAINT material_per_period_course_deleted_by_foreign FOREIGN KEY (deleted_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY materials.material_per_period_course
    ADD CONSTRAINT material_per_period_course_material_per_period_ballot_id_foreig FOREIGN KEY (material_per_period_ballot_id) REFERENCES materials.material_per_period_ballot(id);
...
ALTER TABLE ONLY materials.material_per_period_course
    ADD CONSTRAINT material_per_period_course_updated_by_foreign FOREIGN KEY (updated_by) REFERENCES auth.users(id);
