...
ALTER TABLE ONLY materials.type_material_template
...
ALTER TABLE ONLY materials.type_material_template
    ADD CONSTRAINT odiseo_type_material_template_created_by_foreign FOREIGN KEY (created_by) REFERENCES auth.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY materials.type_material_template
    ADD CONSTRAINT odiseo_type_material_template_deleted_by_foreign FOREIGN KEY (deleted_by) REFERENCES auth.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY materials.type_material_template
    ADD CONSTRAINT odiseo_type_material_template_updated_by_foreign FOREIGN KEY (updated_by) REFERENCES auth.users(id) ON DELETE SET NULL;
