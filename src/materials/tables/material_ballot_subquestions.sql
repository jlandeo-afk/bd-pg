...
ALTER TABLE ONLY materials.material_ballot_subquestions
...
CREATE INDEX idx_mbs_parent_q ON materials.material_ballot_subquestions USING btree (material_ballot_question_id);
...
ALTER TABLE ONLY materials.material_ballot_subquestions
    ADD CONSTRAINT fk_mbs_ballot_q FOREIGN KEY (material_ballot_question_id) REFERENCES materials.material_ballot_question(id);
...
ALTER TABLE ONLY materials.material_ballot_subquestions
    ADD CONSTRAINT fk_mbs_question FOREIGN KEY (question_id) REFERENCES questions.question(id);
