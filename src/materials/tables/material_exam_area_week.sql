...
ALTER TABLE ONLY materials.material_exam_area_week
...
ALTER TABLE ONLY materials.material_exam_area_week
    ADD CONSTRAINT odiseo_material_exam_area_week_created_by_foreign FOREIGN KEY (created_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY materials.material_exam_area_week
    ADD CONSTRAINT odiseo_material_exam_area_week_deleted_by_foreign FOREIGN KEY (deleted_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY materials.material_exam_area_week
    ADD CONSTRAINT odiseo_material_exam_area_week_updated_by_foreign FOREIGN KEY (updated_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY materials.material_exam_area_week
    ADD CONSTRAINT odiseo_material_exam_area_week_week_type_material_id_foreign FOREIGN KEY (week_type_material_id) REFERENCES academic.detail_week_type_mat(id);
