-- Function: organization.fn_list_teachers_by_company(bigint, jsonb)

--

CREATE FUNCTION organization.fn_list_teachers_by_company(p_company_id bigint, p_courses jsonb) RETURNS TABLE(id bigint, value text, courses jsonb, fl_status boolean)
...
ALTER FUNCTION organization.fn_list_teachers_by_company(p_company_id bigint, p_courses jsonb) OWNER TO postgres;
