            ...
            BEGIN
                ...
                IF v_exists_social_reason IS NULL THEN
                    ...
                    IF v_exists_document_number IS NULL THEN
                        ...
                        UPDATE common.prospect
                        SET fl_validate = true
                        WHERE id = p_prospect_id
                        AND fl_status = true;

                        -- Crear usuario admin
                        INSERT INTO auth.users (uuid, "user", password, status_session, company_id, created_by, created_at)
