 ...
 WITH parent_origin_with_names AS (
         SELECT opq.parent_id,
           ...
           FROM (((questions.origin_parent_question opq
             LEFT JOIN academic.modality_options mo ON ((mo.id = opq.modality_option_id)))
