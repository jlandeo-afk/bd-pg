...
CREATE OR REPLACE FUNCTION auth.fn_nq_create_user_token(p_user_uuid uuid, p_nq_user character varying, p_nq_token character varying, p_nq_token_expiration_date timestamp with time zone, p_created_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
