...
CREATE FUNCTION auth.fn_create_rol(p_name character varying, p_slug character varying, p_description character varying, p_created_by integer, p_company_id integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
    DECLARE
