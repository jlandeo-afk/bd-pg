...
ALTER TABLE ONLY academic.syllabus_text_distributions
...
ALTER TABLE ONLY academic.syllabus_text_distributions
    ADD CONSTRAINT syllabus_text_distributions_created_by_foreign FOREIGN KEY (created_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY academic.syllabus_text_distributions
    ADD CONSTRAINT syllabus_text_distributions_syllabus_text_week_id_foreign FOREIGN KEY (syllabus_text_week_id) REFERENCES academic.syllabus_text_weeks(id);
...
ALTER TABLE ONLY academic.syllabus_text_distributions
    ADD CONSTRAINT syllabus_text_distributions_updated_by_foreign FOREIGN KEY (updated_by) REFERENCES auth.users(id);
