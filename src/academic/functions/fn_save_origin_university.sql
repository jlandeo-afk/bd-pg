-- Function: academic.fn_save_origin_university(character varying, character varying, smallint, smallint, jsonb, text, text, bigint)

--

CREATE FUNCTION academic.fn_save_origin_university(p_name character varying, p_slug character varying, p_type smallint, p_region_id smallint, p_options jsonb, p_areas text, p_versions text, p_created_by bigint) RETURNS TABLE(v_validated boolean, v_type integer, v_id bigint)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION academic.fn_save_origin_university(p_name character varying, p_slug character varying, p_type smallint, p_region_id smallint, p_options jsonb, p_areas text, p_versions text, p_created_by bigint) OWNER TO postgres;
