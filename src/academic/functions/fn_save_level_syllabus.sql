-- Function: academic.fn_save_level_syllabus(smallint, bigint, jsonb, jsonb, jsonb, jsonb, jsonb, bigint, bigint)

--

CREATE FUNCTION academic.fn_save_level_syllabus(p_university_id smallint, p_cycle_id bigint, p_week_ids jsonb, p_headquarters_ids jsonb, p_course_ids jsonb, p_detail_level_syllabus jsonb, p_detail_level_syllabus_parent jsonb, p_created_by bigint, p_company_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
            DECLARE
...
ALTER FUNCTION academic.fn_save_level_syllabus(p_university_id smallint, p_cycle_id bigint, p_week_ids jsonb, p_headquarters_ids jsonb, p_course_ids jsonb, p_detail_level_syllabus jsonb, p_detail_level_syllabus_parent jsonb, p_created_by bigint, p_company_id bigint) OWNER TO postgres;
