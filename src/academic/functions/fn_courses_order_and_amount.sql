-- Function: academic.fn_courses_order_and_amount(smallint, bigint, smallint)

--

CREATE FUNCTION academic.fn_courses_order_and_amount(p_type_material_id smallint, p_area_id bigint, p_university_id smallint) RETURNS TABLE(course_id bigint, course character varying, amount_question integer, "position" smallint, initial bigint)
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION academic.fn_courses_order_and_amount(p_type_material_id smallint, p_area_id bigint, p_university_id smallint) OWNER TO postgres;
