-- Function: academic.fn_update_configuration_diagrammed_course(bigint, jsonb, bigint, bigint)

--

CREATE FUNCTION academic.fn_update_configuration_diagrammed_course(p_course_id bigint, p_setting_diagram_course jsonb, p_category_text_id bigint, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
                    BEGIN
                        IF EXISTS (
...
ALTER FUNCTION academic.fn_update_configuration_diagrammed_course(p_course_id bigint, p_setting_diagram_course jsonb, p_category_text_id bigint, p_updated_by bigint) OWNER TO postgres;
