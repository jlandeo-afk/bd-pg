    ...
    AS $$
        ...
        BEGIN
            ...
            WITH tbl_employee_university AS (
                ...
                INNER JOIN academic.origin_university u ON eu.university_id = u.id
                WHERE 1 = 1
...
ALTER FUNCTION academic.fn_get_employee_university(p_per_page integer, p_n_page integer, p_employee_id bigint, p_university_id smallint, p_search character varying) OWNER TO postgres;
