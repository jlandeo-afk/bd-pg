...
ALTER FUNCTION academic.fn_total_text_by_courses_levels(p_university_id integer, p_cycle_id integer, p_headquarter_id integer, p_week integer, p_type_material_id integer, p_courses integer[]) OWNER TO postgres;
