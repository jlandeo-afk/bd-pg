-- Function: academic.fn_create_cycle(character varying, character varying, smallint, smallint, date, date, smallint, bigint, smallint, bigint, jsonb, boolean, integer, bigint)

--

CREATE FUNCTION academic.fn_create_cycle(p_code character varying, p_description character varying, p_month smallint, p_year smallint, p_start_date date, p_end_date date, p_weeks smallint, p_cycle_type_id bigint, p_days smallint, p_type_template_id bigint, p_cycle_weeks jsonb, p_active boolean, p_company_id integer, p_user bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
                    DECLARE
                        v_cycle_id BIGINT;
...
ALTER FUNCTION academic.fn_create_cycle(p_code character varying, p_description character varying, p_month smallint, p_year smallint, p_start_date date, p_end_date date, p_weeks smallint, p_cycle_type_id bigint, p_days smallint, p_type_template_id bigint, p_cycle_weeks jsonb, p_active boolean, p_company_id integer, p_user bigint) OWNER TO postgres;
