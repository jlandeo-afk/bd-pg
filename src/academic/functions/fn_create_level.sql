-- Function: academic.fn_create_level(character varying, character varying, jsonb, integer)

--

CREATE FUNCTION academic.fn_create_level(p_name character varying, p_description character varying, p_courses jsonb, p_created_by integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
        BEGIN
...
ALTER FUNCTION academic.fn_create_level(p_name character varying, p_description character varying, p_courses jsonb, p_created_by integer) OWNER TO postgres;
