-- Function: academic.get_syllabus_text_weekly(integer, integer)

--

CREATE FUNCTION academic.get_syllabus_text_weekly(p_syllabus_id integer, p_company_id integer) RETURNS TABLE(syllabus_text_payload jsonb)
    LANGUAGE plpgsql
    AS $$
            BEGIN
                RETURN QUERY
...
ALTER FUNCTION academic.get_syllabus_text_weekly(p_syllabus_id integer, p_company_id integer) OWNER TO postgres;
