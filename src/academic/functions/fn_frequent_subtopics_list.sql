-- Function: academic.fn_frequent_subtopics_list(bigint, integer, integer, jsonb, smallint, smallint, integer, bigint, integer, integer, character varying, character varying)

--

CREATE FUNCTION academic.fn_frequent_subtopics_list(p_option_id bigint, p_start_year integer, p_end_year integer, p_areas jsonb, p_university_id smallint, p_course_id smallint, p_company_id integer, p_user_id bigint, p_perpage integer, p_npage integer, p_order_column character varying, p_order_direction character varying) RETURNS TABLE(course text, topic text, subtopic text, years jsonb, version text, frequency text, frecuency_value bigint, areas jsonb, total bigint)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION academic.fn_frequent_subtopics_list(p_option_id bigint, p_start_year integer, p_end_year integer, p_areas jsonb, p_university_id smallint, p_course_id smallint, p_company_id integer, p_user_id bigint, p_perpage integer, p_npage integer, p_order_column character varying, p_order_direction character varying) OWNER TO postgres;
