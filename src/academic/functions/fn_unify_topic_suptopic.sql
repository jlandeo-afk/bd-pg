-- Function: academic.fn_unify_topic_suptopic(jsonb, integer)

--

CREATE FUNCTION academic.fn_unify_topic_suptopic(p_detail jsonb, p_user_id integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
        WITH 
...
ALTER FUNCTION academic.fn_unify_topic_suptopic(p_detail jsonb, p_user_id integer) OWNER TO postgres;
