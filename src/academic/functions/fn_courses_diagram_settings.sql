-- Function: academic.fn_courses_diagram_settings()

--

CREATE FUNCTION academic.fn_courses_diagram_settings() RETURNS TABLE(id smallint, code character varying, name character varying, apply_text boolean)
    LANGUAGE plpgsql
    AS $$
            BEGIN
                    RETURN QUERY
...
ALTER FUNCTION academic.fn_courses_diagram_settings() OWNER TO postgres;
