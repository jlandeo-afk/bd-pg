...
ALTER FUNCTION academic.fn_list_topics_by_universities_and_course_or_pseudo(f_university_ids jsonb, f_course_id bigint, p_fl_pseudo boolean, p_option_id bigint, p_start_year integer, p_end_year integer, p_areas jsonb, p_company_id integer, p_show_frequent boolean) OWNER TO postgres;
