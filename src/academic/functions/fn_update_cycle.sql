-- Function: academic.fn_update_cycle(bigint, character varying, character varying, smallint, smallint, date, date, smallint, smallint, smallint, bigint, jsonb, boolean, integer, bigint)

--

CREATE FUNCTION academic.fn_update_cycle(p_id bigint, p_code character varying, p_description character varying, p_month smallint, p_year smallint, p_start_date date, p_end_date date, p_weeks smallint, p_cycle_type_id smallint, p_days smallint, p_type_template_id bigint, p_cycle_weeks jsonb, p_active boolean, p_company_id integer, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
                    BEGIN
...
ALTER FUNCTION academic.fn_update_cycle(p_id bigint, p_code character varying, p_description character varying, p_month smallint, p_year smallint, p_start_date date, p_end_date date, p_weeks smallint, p_cycle_type_id smallint, p_days smallint, p_type_template_id bigint, p_cycle_weeks jsonb, p_active boolean, p_company_id integer, p_updated_by bigint) OWNER TO postgres;
