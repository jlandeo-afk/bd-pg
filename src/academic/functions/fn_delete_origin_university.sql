-- Function: academic.fn_delete_origin_university(smallint, bigint)

--

CREATE FUNCTION academic.fn_delete_origin_university(p_id smallint, p_deleted_by bigint) RETURNS TABLE(v_validated boolean, v_id smallint)
    LANGUAGE plpgsql
    AS $$
    DECLARE
        v_exits_id BIGINT;
...
ALTER FUNCTION academic.fn_delete_origin_university(p_id smallint, p_deleted_by bigint) OWNER TO postgres;
