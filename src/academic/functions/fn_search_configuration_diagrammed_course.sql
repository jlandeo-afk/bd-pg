-- Function: academic.fn_search_configuration_diagrammed_course(character varying)

--

CREATE FUNCTION academic.fn_search_configuration_diagrammed_course(p_text character varying) RETURNS TABLE(course_id bigint, name_course character varying, category_text_id bigint, category_text character varying)
    LANGUAGE plpgsql
    AS $$
            BEGIN
                    RETURN QUERY
...
ALTER FUNCTION academic.fn_search_configuration_diagrammed_course(p_text character varying) OWNER TO postgres;
