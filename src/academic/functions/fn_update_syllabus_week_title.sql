-- Function: academic.fn_update_syllabus_week_title(bigint, integer, character varying, bigint, integer)

--

CREATE FUNCTION academic.fn_update_syllabus_week_title(p_syllabus_id bigint, p_week integer, p_title character varying, p_company_id bigint, p_user_id integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION academic.fn_update_syllabus_week_title(p_syllabus_id bigint, p_week integer, p_title character varying, p_company_id bigint, p_user_id integer) OWNER TO postgres;
