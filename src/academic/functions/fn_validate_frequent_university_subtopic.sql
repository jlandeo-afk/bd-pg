-- Function: academic.fn_validate_frequent_university_subtopic(integer, smallint, integer)

--

CREATE FUNCTION academic.fn_validate_frequent_university_subtopic(p_question_id integer, p_university smallint, p_updated_by integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION academic.fn_validate_frequent_university_subtopic(p_question_id integer, p_university smallint, p_updated_by integer) OWNER TO postgres;
