-- Function: academic.fn_find_syllabus_text(bigint, bigint, bigint)

--

CREATE FUNCTION academic.fn_find_syllabus_text(p_syllabus_id bigint, p_course_id bigint, p_company_id bigint) RETURNS TABLE(category character varying, category_id integer, weeks jsonb)
    LANGUAGE plpgsql
    AS $$
                BEGIN
                    RETURN QUERY
...
ALTER FUNCTION academic.fn_find_syllabus_text(p_syllabus_id bigint, p_course_id bigint, p_company_id bigint) OWNER TO postgres;
