-- Function: academic.fn_process_change_subtopic_frequent(integer, integer, integer, character varying)

--

CREATE FUNCTION academic.fn_process_change_subtopic_frequent(p_question_id integer, p_new_subtopic_id integer, p_user_id integer, p_method_origin character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
                                DECLARE
...
ALTER FUNCTION academic.fn_process_change_subtopic_frequent(p_question_id integer, p_new_subtopic_id integer, p_user_id integer, p_method_origin character varying) OWNER TO postgres;
