-- Function: academic.fn_modalities_university(integer, integer)

--

CREATE FUNCTION academic.fn_modalities_university(p_options integer, p_university integer) RETURNS TABLE(id integer, name character varying, option_ids jsonb)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION academic.fn_modalities_university(p_options integer, p_university integer) OWNER TO postgres;
