-- Function: academic.fn_change_user_courses(bigint, jsonb, bigint, bigint)

--

CREATE FUNCTION academic.fn_change_user_courses(p_employee_id bigint, p_courses jsonb, p_company_id bigint, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
        WITH get_courses AS (
...
ALTER FUNCTION academic.fn_change_user_courses(p_employee_id bigint, p_courses jsonb, p_company_id bigint, p_updated_by bigint) OWNER TO postgres;
