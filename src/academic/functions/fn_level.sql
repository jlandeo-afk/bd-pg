...
ALTER FUNCTION academic.fn_level(p_perpage integer, p_npage integer, p_search character varying, p_course_id smallint, f_status boolean) OWNER TO postgres;
