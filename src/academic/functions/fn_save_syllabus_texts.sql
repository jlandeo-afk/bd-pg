-- Function: academic.fn_save_syllabus_texts(smallint, smallint, smallint, bigint, jsonb, jsonb, bigint, bigint)

--

CREATE FUNCTION academic.fn_save_syllabus_texts(p_university_id smallint, p_course_id smallint, p_pseudo_course_id smallint, p_cycle_id bigint, p_syllabus jsonb, p_syllabus_week_titles jsonb, p_created_by bigint, p_company_id bigint) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
    DECLARE
...
ALTER FUNCTION academic.fn_save_syllabus_texts(p_university_id smallint, p_course_id smallint, p_pseudo_course_id smallint, p_cycle_id bigint, p_syllabus jsonb, p_syllabus_week_titles jsonb, p_created_by bigint, p_company_id bigint) OWNER TO postgres;
