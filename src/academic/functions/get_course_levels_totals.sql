-- Function: academic.get_course_levels_totals(integer, integer, integer, integer, integer)

--

CREATE FUNCTION academic.get_course_levels_totals(p_cycle_id integer, p_week integer, p_type_material_id integer, p_university_id integer, p_headquarter_id integer) RETURNS TABLE(course_id bigint, levels_total numeric)
    LANGUAGE plpgsql
    AS $$
            BEGIN
                RETURN QUERY
...
ALTER FUNCTION academic.get_course_levels_totals(p_cycle_id integer, p_week integer, p_type_material_id integer, p_university_id integer, p_headquarter_id integer) OWNER TO postgres;
