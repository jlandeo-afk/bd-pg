-- Function: academic.fn_update_subtopic_syllabus(bigint, bigint, bigint, boolean, bigint, bigint)

--

CREATE FUNCTION academic.fn_update_subtopic_syllabus(p_syllabus_id bigint, p_subtopic_id bigint, p_new_topic_id bigint, p_is_modified boolean, p_company_id bigint, p_user bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION academic.fn_update_subtopic_syllabus(p_syllabus_id bigint, p_subtopic_id bigint, p_new_topic_id bigint, p_is_modified boolean, p_company_id bigint, p_user bigint) OWNER TO postgres;
