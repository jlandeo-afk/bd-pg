-- Function: academic.fn_field_diagramm_by_course(smallint, bigint)

--

CREATE FUNCTION academic.fn_field_diagramm_by_course(p_course_id smallint, p_question_id bigint) RETURNS TABLE(id bigint, name character varying, fl_optional boolean)
    LANGUAGE plpgsql
    AS $$
                    BEGIN
                        RETURN QUERY
...
ALTER FUNCTION academic.fn_field_diagramm_by_course(p_course_id smallint, p_question_id bigint) OWNER TO postgres;
