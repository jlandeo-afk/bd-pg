-- Function: academic.fn_get_university_by_employee_of_syllabus(bigint, bigint)

--

CREATE FUNCTION academic.fn_get_university_by_employee_of_syllabus(p_employee_id bigint, p_company_id bigint) RETURNS TABLE(id smallint, name text, university character varying, quantity bigint, fl_template boolean)
    LANGUAGE plpgsql
    AS $$
    BEGIN
        RETURN QUERY
...
ALTER FUNCTION academic.fn_get_university_by_employee_of_syllabus(p_employee_id bigint, p_company_id bigint) OWNER TO postgres;
