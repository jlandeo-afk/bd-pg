-- Function: academic.fn_save_course_subcategory(bigint, character varying, integer, bigint)

--

CREATE FUNCTION academic.fn_save_course_subcategory(p_assigned_cat_id bigint, p_subcategory_name character varying, p_subcategory_id integer, p_user_id bigint) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
            DECLARE
                v_sub_id INT;
...
ALTER FUNCTION academic.fn_save_course_subcategory(p_assigned_cat_id bigint, p_subcategory_name character varying, p_subcategory_id integer, p_user_id bigint) OWNER TO postgres;
