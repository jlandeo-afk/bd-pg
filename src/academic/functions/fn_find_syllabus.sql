-- Function: academic.fn_find_syllabus(bigint, bigint)

--

CREATE FUNCTION academic.fn_find_syllabus(p_syllabus_id bigint, p_company_id bigint) RETURNS TABLE(id bigint, university_id smallint, code_university character varying, slug_university character varying, university character varying, course_id bigint, apply_text_on_syllabus boolean, pseudo_course_id bigint, code_course character varying, course character varying, cycle_id bigint, code_cycle character varying, cycle character varying, weeks smallint, start_date date, end_date date, syllabus jsonb, syllabus_week_titles jsonb, cycle_template_id bigint, type_text_template_id smallint)
    LANGUAGE plpgsql
    AS $$
                    DECLARE
...
ALTER FUNCTION academic.fn_find_syllabus(p_syllabus_id bigint, p_company_id bigint) OWNER TO postgres;
