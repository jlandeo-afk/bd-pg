...
ALTER FUNCTION academic.fn_get_all_course_by_employee_and_university(p_employee_id bigint, p_university_id smallint, p_company_id bigint) OWNER TO postgres;
