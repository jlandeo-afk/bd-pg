-- Function: academic.fn_disable_outdated_frequent_subtopics()

--

CREATE FUNCTION academic.fn_disable_outdated_frequent_subtopics() RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
ALTER FUNCTION academic.fn_disable_outdated_frequent_subtopics() OWNER TO postgres;
