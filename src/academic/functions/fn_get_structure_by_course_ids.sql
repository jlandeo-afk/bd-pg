-- Function: academic.fn_get_structure_by_course_ids(jsonb)

--

CREATE FUNCTION academic.fn_get_structure_by_course_ids(course_ids_json jsonb) RETURNS TABLE(unification json)
    LANGUAGE plpgsql
    AS $$
    DECLARE
        v_cid1 INTEGER;
...
ALTER FUNCTION academic.fn_get_structure_by_course_ids(course_ids_json jsonb) OWNER TO postgres;
