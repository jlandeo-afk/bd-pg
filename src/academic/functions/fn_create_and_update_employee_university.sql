-- Function: academic.fn_create_and_update_employee_university(bigint, jsonb, bigint)

--

CREATE FUNCTION academic.fn_create_and_update_employee_university(p_employee_id bigint, p_universities_id jsonb, p_created_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION academic.fn_create_and_update_employee_university(p_employee_id bigint, p_universities_id jsonb, p_created_by bigint) OWNER TO postgres;
