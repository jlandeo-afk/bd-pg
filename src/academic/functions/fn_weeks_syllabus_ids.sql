-- Function: academic.fn_weeks_syllabus_ids(jsonb)

--

CREATE FUNCTION academic.fn_weeks_syllabus_ids(p_syllabus_topic_ids jsonb) RETURNS TABLE(id bigint, syllabus_topic_id bigint, week smallint, total_questions_amount smallint, created_at timestamp without time zone, subtopics jsonb)
    LANGUAGE plpgsql
    AS $$
                    BEGIN
                        RETURN QUERY
...
ALTER FUNCTION academic.fn_weeks_syllabus_ids(p_syllabus_topic_ids jsonb) OWNER TO postgres;
