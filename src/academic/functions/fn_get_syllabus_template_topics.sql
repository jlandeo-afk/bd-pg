-- Function: academic.fn_get_syllabus_template_topics(integer, integer, boolean, integer, integer, bigint)

--

CREATE FUNCTION academic.fn_get_syllabus_template_topics(p_university_id integer, p_course_id integer, p_fl_pseudo boolean, p_category_id integer, p_type_text_subcategory_id integer, p_company_id bigint) RETURNS TABLE(syllabus_template_topic_id integer, topic_id smallint, topic_code character varying, name text, category_id bigint, subcategory_id bigint)
    LANGUAGE plpgsql
    AS $$
                BEGIN
                    RETURN QUERY
...
ALTER FUNCTION academic.fn_get_syllabus_template_topics(p_university_id integer, p_course_id integer, p_fl_pseudo boolean, p_category_id integer, p_type_text_subcategory_id integer, p_company_id bigint) OWNER TO postgres;
