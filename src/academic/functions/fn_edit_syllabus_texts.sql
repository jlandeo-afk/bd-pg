-- Function: academic.fn_edit_syllabus_texts(bigint, jsonb, bigint, boolean, bigint)

--

CREATE FUNCTION academic.fn_edit_syllabus_texts(p_syllabus_id bigint, p_payload jsonb, p_user_id bigint, p_is_partial_update boolean, p_company_id bigint) RETURNS text
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION academic.fn_edit_syllabus_texts(p_syllabus_id bigint, p_payload jsonb, p_user_id bigint, p_is_partial_update boolean, p_company_id bigint) OWNER TO postgres;
