-- Function: academic.fn_edit_syllabus(bigint, jsonb, bigint, bigint)

--

CREATE FUNCTION academic.fn_edit_syllabus(p_syllabus_id bigint, p_syllabus jsonb, p_company_id bigint, p_updated_by bigint) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
        DECLARE
            v_syllabus JSONB;
...
ALTER FUNCTION academic.fn_edit_syllabus(p_syllabus_id bigint, p_syllabus jsonb, p_company_id bigint, p_updated_by bigint) OWNER TO postgres;
