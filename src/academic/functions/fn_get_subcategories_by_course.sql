-- Function: academic.fn_get_subcategories_by_course(bigint, bigint)

--

CREATE FUNCTION academic.fn_get_subcategories_by_course(p_course_id bigint, p_assigned_category_id bigint) RETURNS TABLE(id bigint, subcategory_name character varying)
    LANGUAGE plpgsql
    AS $$
            BEGIN
                RETURN QUERY
...
ALTER FUNCTION academic.fn_get_subcategories_by_course(p_course_id bigint, p_assigned_category_id bigint) OWNER TO postgres;
