-- Function: academic.fn_diagrammed_by_course_category(smallint, bigint)

--

CREATE FUNCTION academic.fn_diagrammed_by_course_category(p_course_id smallint, p_category_id bigint) RETURNS TABLE(id bigint, name character varying, fl_optional boolean)
    LANGUAGE plpgsql
    AS $$
        BEGIN
            RETURN QUERY
...
ALTER FUNCTION academic.fn_diagrammed_by_course_category(p_course_id smallint, p_category_id bigint) OWNER TO postgres;
