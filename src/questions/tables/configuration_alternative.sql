...
ALTER TABLE ONLY questions.configuration_alternative
...
ALTER TABLE ONLY questions.configuration_alternative
    ADD CONSTRAINT odiseo_configuration_alternative_created_by_foreign FOREIGN KEY (created_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY questions.configuration_alternative
    ADD CONSTRAINT odiseo_configuration_alternative_deleted_by_foreign FOREIGN KEY (deleted_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY questions.configuration_alternative
    ADD CONSTRAINT odiseo_configuration_alternative_updated_by_foreign FOREIGN KEY (updated_by) REFERENCES auth.users(id);
