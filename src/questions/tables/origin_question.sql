...
ALTER TABLE ONLY questions.origin_question
...
ALTER TABLE ONLY questions.origin_question
    ADD CONSTRAINT origin_question_modality_id_foreign FOREIGN KEY (modality_id) REFERENCES academic.modality(id);
...
ALTER TABLE ONLY questions.origin_question
    ADD CONSTRAINT origin_question_option_id_foreign FOREIGN KEY (option_id) REFERENCES academic.option(id);
...
ALTER TABLE ONLY questions.origin_question
    ADD CONSTRAINT origin_question_question_id_foreign FOREIGN KEY (question_id) REFERENCES questions.question(id);
...
ALTER TABLE ONLY questions.origin_question
    ADD CONSTRAINT origin_question_university_id_foreign FOREIGN KEY (university_id) REFERENCES academic.origin_university(id);
