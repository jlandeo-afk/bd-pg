-- Function: questions.fn_validate_history_question(bigint, bigint)

--

CREATE FUNCTION questions.fn_validate_history_question(p_material_id bigint, p_question_id bigint) RETURNS TABLE(fl_validate boolean, v_message text)
    LANGUAGE plpgsql
    AS $$
        DECLARE
            v_cycle_id BIGINT;
...
ALTER FUNCTION questions.fn_validate_history_question(p_material_id bigint, p_question_id bigint) OWNER TO postgres;
