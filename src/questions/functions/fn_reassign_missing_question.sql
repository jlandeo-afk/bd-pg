-- Function: questions.fn_reassign_missing_question(bigint, bigint, bigint)

--

CREATE FUNCTION questions.fn_reassign_missing_question(p_detail_id bigint, p_new_employee_id bigint, p_created_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION questions.fn_reassign_missing_question(p_detail_id bigint, p_new_employee_id bigint, p_created_by bigint) OWNER TO postgres;
