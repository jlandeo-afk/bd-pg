-- Function: questions.fn_insert_question_with_alternatives_v2(character varying, character varying, smallint, smallint, text, text, integer, jsonb, jsonb, jsonb, bigint, jsonb, character varying, boolean, bigint, integer, integer, smallint)

--

CREATE FUNCTION questions.fn_insert_question_with_alternatives_v2(p_code_course character varying, p_num_problem character varying, p_topic_id smallint, p_question_columns smallint, p_question_text text, p_question_short text, p_parent_id integer, p_question_images jsonb, p_alternatives jsonb, p_alternative_images jsonb, p_config_alternative_id bigint, p_origin jsonb, p_authorship character varying, p_diagrammed boolean, p_created_by bigint, p_week_id integer, p_type_material_template_id integer, p_priority smallint) RETURNS TABLE(question_id bigint, description text, short_description text, code character varying, status character varying, course_id smallint, parent_id bigint, alternatives jsonb)
    LANGUAGE plpgsql
    AS $$
                    DECLARE
...
ALTER FUNCTION questions.fn_insert_question_with_alternatives_v2(p_code_course character varying, p_num_problem character varying, p_topic_id smallint, p_question_columns smallint, p_question_text text, p_question_short text, p_parent_id integer, p_question_images jsonb, p_alternatives jsonb, p_alternative_images jsonb, p_config_alternative_id bigint, p_origin jsonb, p_authorship character varying, p_diagrammed boolean, p_created_by bigint, p_week_id integer, p_type_material_template_id integer, p_priority smallint) OWNER TO postgres;
