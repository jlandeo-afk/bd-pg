-- Function: questions.fn_change_assigned_question_didi(bigint, bigint, bigint)

--

CREATE FUNCTION questions.fn_change_assigned_question_didi(p_id bigint, p_employee_id bigint, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION questions.fn_change_assigned_question_didi(p_id bigint, p_employee_id bigint, p_updated_by bigint) OWNER TO postgres;
