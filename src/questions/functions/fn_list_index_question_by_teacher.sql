...
ALTER FUNCTION questions.fn_list_index_question_by_teacher(p_perpage integer, p_npage integer, p_name_text character varying, f_course_ids integer[], f_teacher_id integer, f_fl_diagrammed boolean, f_type character varying, f_status character varying) OWNER TO postgres;
