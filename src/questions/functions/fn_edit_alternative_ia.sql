-- Function: questions.fn_edit_alternative_ia(bigint, text, jsonb, bigint)

--

CREATE FUNCTION questions.fn_edit_alternative_ia(p_id bigint, p_description text, p_images jsonb, p_updated_by bigint) RETURNS TABLE(alternative_ia_id bigint)
    LANGUAGE plpgsql
    AS $$
        BEGIN
            RETURN QUERY
...
ALTER FUNCTION questions.fn_edit_alternative_ia(p_id bigint, p_description text, p_images jsonb, p_updated_by bigint) OWNER TO postgres;
