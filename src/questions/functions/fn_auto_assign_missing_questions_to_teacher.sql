-- Function: questions.fn_auto_assign_missing_questions_to_teacher(bigint, bigint, integer)

--

CREATE FUNCTION questions.fn_auto_assign_missing_questions_to_teacher(p_employee_id bigint, p_course_id bigint, p_limit integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION questions.fn_auto_assign_missing_questions_to_teacher(p_employee_id bigint, p_course_id bigint, p_limit integer) OWNER TO postgres;
