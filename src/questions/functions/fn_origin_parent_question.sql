-- Function: questions.fn_origin_parent_question(bigint)

--

CREATE FUNCTION questions.fn_origin_parent_question(p_parent_question_id bigint) RETURNS TABLE(id bigint, parent_id bigint, year character varying, region_id bigint, region character varying, university_id bigint, university character varying, option_id bigint, option character varying, modality_id bigint, modality character varying, areas character varying, version character varying, order_version integer)
    LANGUAGE plpgsql
    AS $$
            BEGIN
                RETURN QUERY
...
ALTER FUNCTION questions.fn_origin_parent_question(p_parent_question_id bigint) OWNER TO postgres;
