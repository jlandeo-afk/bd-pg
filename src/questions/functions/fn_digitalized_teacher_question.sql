...
ALTER FUNCTION questions.fn_digitalized_teacher_question(p_perpage integer, p_npage integer, p_name_text character varying, p_teacher_id integer, f_employee_didi_id integer, f_course_id integer[], f_status character varying, f_type character varying) OWNER TO postgres;
