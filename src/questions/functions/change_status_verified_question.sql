-- Function: questions.change_status_verified_question(integer, character varying, character varying, integer)

--

CREATE FUNCTION questions.change_status_verified_question(p_question_id integer, p_status character varying, p_observations character varying, p_user_id integer) RETURNS json
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION questions.change_status_verified_question(p_question_id integer, p_status character varying, p_observations character varying, p_user_id integer) OWNER TO postgres;
