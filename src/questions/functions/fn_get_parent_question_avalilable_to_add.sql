...
ALTER FUNCTION questions.fn_get_parent_question_avalilable_to_add(p_perpage integer, p_npage integer, p_search character varying, p_course_id smallint, p_category_id integer[], p_subcategory_id integer[], p_level_id smallint, p_material_id bigint, p_distribution_id bigint) OWNER TO postgres;
