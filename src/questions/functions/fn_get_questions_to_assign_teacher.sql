-- Function: questions.fn_get_questions_to_assign_teacher()

--

CREATE FUNCTION questions.fn_get_questions_to_assign_teacher() RETURNS TABLE(type_question text, id bigint, course_id bigint, questions json, priority integer, created_at timestamp without time zone)
    LANGUAGE sql
    AS $$
...
ALTER FUNCTION questions.fn_get_questions_to_assign_teacher() OWNER TO postgres;
