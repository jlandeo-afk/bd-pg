-- Function: questions.fn_update_essential_knowledge_by_question(bigint, jsonb, bigint)

--

CREATE FUNCTION questions.fn_update_essential_knowledge_by_question(p_question_id bigint, p_essential_knowledge_ids jsonb, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION questions.fn_update_essential_knowledge_by_question(p_question_id bigint, p_essential_knowledge_ids jsonb, p_updated_by bigint) OWNER TO postgres;
