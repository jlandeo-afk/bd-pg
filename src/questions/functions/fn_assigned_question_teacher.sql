...
ALTER FUNCTION questions.fn_assigned_question_teacher(p_perpage integer, p_npage integer, p_name_text character varying, f_status character varying, f_course_ids integer[], f_type character varying, f_teacher_id integer, f_user_id integer, f_week_id integer) OWNER TO postgres;
