-- Function: questions.fn_migrate_diagrammed_fields()

--

CREATE FUNCTION questions.fn_migrate_diagrammed_fields() RETURNS TABLE(question_id bigint, question_code character varying, employee_didi_question_id bigint, deactivated_field_id bigint, created_field_id bigint)
    LANGUAGE plpgsql
    AS $$
                    DECLARE
...
ALTER FUNCTION questions.fn_migrate_diagrammed_fields() OWNER TO postgres;
