-- Function: questions.fn_find_parent_question(bigint)

--

CREATE FUNCTION questions.fn_find_parent_question(p_parent_question_id bigint) RETURNS TABLE(subquestion jsonb, parent_id bigint, category_id bigint, category character varying, subcategory_id bigint, subcategory character varying, level_id bigint, course_id smallint)
    LANGUAGE plpgsql
    AS $$
        BEGIN
            RETURN QUERY
...
ALTER FUNCTION questions.fn_find_parent_question(p_parent_question_id bigint) OWNER TO postgres;
