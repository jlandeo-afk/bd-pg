-- Function: questions.get_detail_question_digitalized_v2(integer)

--

CREATE FUNCTION questions.get_detail_question_digitalized_v2(p_question_id integer) RETURNS TABLE(question_id bigint, diagram_fields jsonb, field_images jsonb)
    LANGUAGE plpgsql
    AS $$
                                    BEGIN
                                        RETURN QUERY
...
ALTER FUNCTION questions.get_detail_question_digitalized_v2(p_question_id integer) OWNER TO postgres;
