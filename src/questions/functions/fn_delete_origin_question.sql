-- Function: questions.fn_delete_origin_question(integer, integer)

--

CREATE FUNCTION questions.fn_delete_origin_question(p_origin_question_id integer, p_user_id integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
            DECLARE
                v_university_id INT;
...
ALTER FUNCTION questions.fn_delete_origin_question(p_origin_question_id integer, p_user_id integer) OWNER TO postgres;
