-- Function: questions.fn_list_eligible_teachers_for_missing_questions()

--

CREATE FUNCTION questions.fn_list_eligible_teachers_for_missing_questions() RETURNS TABLE(employee_id integer, limit_missing_questions integer, teacher_name text, courses json)
...
ALTER FUNCTION questions.fn_list_eligible_teachers_for_missing_questions() OWNER TO postgres;
