...
ALTER FUNCTION questions.fn_get_missing_questions_text_search(p_material_id bigint, p_type_material_id smallint, p_start_week smallint, p_end_week smallint) OWNER TO postgres;
