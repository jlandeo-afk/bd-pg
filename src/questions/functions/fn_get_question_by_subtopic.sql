-- Function: questions.fn_get_question_by_subtopic(bigint)

--

CREATE FUNCTION questions.fn_get_question_by_subtopic(p_subtopic_id bigint) RETURNS TABLE(id bigint, subtopics jsonb)
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION questions.fn_get_question_by_subtopic(p_subtopic_id bigint) OWNER TO postgres;
