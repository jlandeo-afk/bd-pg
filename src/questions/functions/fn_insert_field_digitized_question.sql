...
ALTER FUNCTION questions.fn_insert_field_digitized_question(p_question_id bigint, p_field_diagram jsonb, p_image jsonb, p_user bigint) OWNER TO postgres;
