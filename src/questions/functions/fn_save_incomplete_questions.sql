-- Function: questions.fn_save_incomplete_questions(bigint, character varying, bigint)

--

CREATE FUNCTION questions.fn_save_incomplete_questions(p_detail_week_type_mat_id bigint, p_url_json character varying, p_updated_by bigint) RETURNS TABLE(id bigint, material_id bigint, week smallint, type_material_id smallint, parent_type_material_id smallint)
    LANGUAGE plpgsql
    AS $$
        BEGIN
            RETURN QUERY
...
ALTER FUNCTION questions.fn_save_incomplete_questions(p_detail_week_type_mat_id bigint, p_url_json character varying, p_updated_by bigint) OWNER TO postgres;
