-- Function: questions.fn_topics_count_questions(smallint)

--

CREATE FUNCTION questions.fn_topics_count_questions(f_course_id smallint) RETURNS TABLE(id smallint, code character varying, name character varying, course_id smallint, count_questions bigint)
    LANGUAGE plpgsql
    AS $$
                    DECLARE
...
ALTER FUNCTION questions.fn_topics_count_questions(f_course_id smallint) OWNER TO postgres;
