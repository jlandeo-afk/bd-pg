...
ALTER FUNCTION questions.fn_archived_question(p_perpage integer, p_npage integer, p_employee_id integer, p_name_text character varying, f_course_id integer, f_type character varying) OWNER TO postgres;
