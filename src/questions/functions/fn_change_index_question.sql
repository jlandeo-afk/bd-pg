-- Function: questions.fn_change_index_question(bigint, bigint, bigint)

--

CREATE FUNCTION questions.fn_change_index_question(p_question_id bigint, p_answer_id bigint, p_updated_by bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
        DECLARE
...
ALTER FUNCTION questions.fn_change_index_question(p_question_id bigint, p_answer_id bigint, p_updated_by bigint) OWNER TO postgres;
