-- Function: questions.fn_change_status_reserved_to_verified(integer, integer)

--

CREATE FUNCTION questions.fn_change_status_reserved_to_verified(p_question_id integer, p_user_id integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
            DECLARE
            ...
            BEGIN
                ...
                IF v_exist_question THEN
                    ...
                    INSERT INTO questions.question_status (
                    ...
                    -- Quitando la observación de la tabla question_observation
                        UPDATE questions.question_observation
                        SET fl_status = false
...
ALTER FUNCTION questions.fn_change_status_reserved_to_verified(p_question_id integer, p_user_id integer) OWNER TO postgres;
