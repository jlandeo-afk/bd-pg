-- Function: questions.fn_paginate_compatible_questions(bigint, integer, integer)

--

CREATE FUNCTION questions.fn_paginate_compatible_questions(p_material_ballot_question_id bigint, p_per_page integer DEFAULT 3, p_page integer DEFAULT 1) RETURNS TABLE(id bigint, total bigint)
...
ALTER FUNCTION questions.fn_paginate_compatible_questions(p_material_ballot_question_id bigint, p_per_page integer, p_page integer) OWNER TO postgres;
