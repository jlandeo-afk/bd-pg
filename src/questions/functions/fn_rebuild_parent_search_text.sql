-- Function: questions.fn_rebuild_parent_search_text(bigint)

--

CREATE FUNCTION questions.fn_rebuild_parent_search_text(v_parent_id bigint) RETURNS void
    LANGUAGE plpgsql
...
ALTER FUNCTION questions.fn_rebuild_parent_search_text(v_parent_id bigint) OWNER TO postgres;
