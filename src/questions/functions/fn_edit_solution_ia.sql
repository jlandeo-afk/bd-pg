-- Function: questions.fn_edit_solution_ia(bigint, text, jsonb, bigint, bigint)

--

CREATE FUNCTION questions.fn_edit_solution_ia(p_id bigint, p_description text, p_images jsonb, p_field_diagrammed_id bigint, p_updated_by bigint) RETURNS TABLE(question_ia_id bigint)
    LANGUAGE plpgsql
    AS $$
    BEGIN
        RETURN QUERY
...
ALTER FUNCTION questions.fn_edit_solution_ia(p_id bigint, p_description text, p_images jsonb, p_field_diagrammed_id bigint, p_updated_by bigint) OWNER TO postgres;
