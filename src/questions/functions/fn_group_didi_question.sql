-- Function: questions.fn_group_didi_question(integer, integer)

--

CREATE FUNCTION questions.fn_group_didi_question(p_week integer, p_year integer) RETURNS TABLE(employee_id bigint, employee_name text, question_total numeric, questions json)
    LANGUAGE plpgsql
    AS $$
            BEGIN
                RETURN QUERY
                ...
                LEFT JOIN (
                    ...
                    FROM
                        questions.employee_didi_question eq
                    INNER JOIN questions.question q
...
ALTER FUNCTION questions.fn_group_didi_question(p_week integer, p_year integer) OWNER TO postgres;
