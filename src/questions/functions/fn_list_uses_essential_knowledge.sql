-- Function: questions.fn_list_uses_essential_knowledge(integer, integer, character varying, bigint)

--

CREATE FUNCTION questions.fn_list_uses_essential_knowledge(p_perpage integer, p_npage integer, p_search character varying, p_essential_knowledge_id bigint) RETURNS TABLE(id bigint, question_id bigint, code character varying, status character varying, total bigint)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION questions.fn_list_uses_essential_knowledge(p_perpage integer, p_npage integer, p_search character varying, p_essential_knowledge_id bigint) OWNER TO postgres;
