-- Function: questions.fn_get_validate_question_ia(bigint)

--

CREATE FUNCTION questions.fn_get_validate_question_ia(p_question_ia_id bigint) RETURNS TABLE(id bigint)
    LANGUAGE plpgsql
    AS $$
        BEGIN
            RETURN QUERY
...
ALTER FUNCTION questions.fn_get_validate_question_ia(p_question_ia_id bigint) OWNER TO postgres;
