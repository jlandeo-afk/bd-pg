...
ALTER FUNCTION questions.fn_list_verified_questions_co(p_perpage integer, p_npage integer, p_name_text character varying, f_teacher_id integer, f_course_id integer[], f_topics_id jsonb, f_subtopics_id jsonb, f_didi_id integer, f_type character varying, f_status json) OWNER TO postgres;
